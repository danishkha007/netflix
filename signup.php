                ...
                <div class="regFormContainer">
                    ...
                    <?php echo $account->getErrorMessage(Constant::$firstNameCharacters);  ?>
                        <div class="group">
                            ...
                            <input type="text" id="fname" name="firstName" value="<?php echo getInputValue('firstName'); ?>" autocomplete="off" required>
                        </div>
                        <?php echo $account->getErrorMessage(Constant::$lastNameCharacters);  ?>
                        <div class="group">
                            <label for="lname">Last Name</label>
                            <input type="text" id="lname" name="lastName" value="<?php echo getInputValue('lastName'); ?>" autocomplete="off" required>
                        </div>
                        <?php echo $account->getErrorMessage(Constant::$emailInValid);  ?>
                        <div class="group">
                            <label for="email">Email</label>
                            <input type="email" id="email" name="email" value="<?php echo $email; ?>" autocomplete="" required>
                        </div>
