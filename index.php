...
?>
    ...
    <section class="banner">
        <img src="frontend/assets/images/banner.jpg" alt="Site Banner" class="our-story-card-background">
        <div class="our-story-card-text">
            ...
            <form action="<?php echo h($_SERVER['PHP_SELF']) ?>" method="POST" class="global-search">
                <div class="f-group">
                    <input type="email" name="email" placeholder="Enter Email Address..." value="<?php echo getInputValue('email');  ?>" autocomplete="off" required>
